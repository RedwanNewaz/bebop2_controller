...
;
    ...
    protected:
        // x_{t+1} = F@x_{t}+B@u_t
        /**
        * @brief  It computes the predicted state of the system based on the motion model. The function creates two Eigen matrices, F_ and B_, which are used to perform the prediction.
        * @param x It is a vector of size 4 representing the current srare of the system.
        * @param y It is a vector of size 4 as well representing the control input of the system.
        */ 
