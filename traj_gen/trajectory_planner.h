...
namespace traj_planner
{
    ...
    {
    public:
        constant_velocity(double max_vel, double max_acc)
                :waypoint_trajectory_interface(max_vel, max_acc)
        {
            this->wp_size_ = 0;
        }
        ...
        void convert_waypoints(const WAYPOINTS& wp) override
        {
            ...
            traj_.clear();
            double time = 0;
            double dt =  m_resolution / max_vel_;
    ...
    {
    public:
        minimum_snap(double max_vel, double max_acc)
                :waypoint_trajectory_interface(max_vel, max_acc)
        {
            this->wp_size_ = 0;
        }
    ...
    {
    public:
        minimum_jerk(double max_vel, double max_acc)
                :waypoint_trajectory_interface(max_vel, max_acc)
        {
            this->wp_size_ = 0;
        }
