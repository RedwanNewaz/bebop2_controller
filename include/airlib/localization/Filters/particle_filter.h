...
/// @brief initializes the mean and covariance matrix for the distribution. The mean and covariance matrix are used in the calculation 
/// along with the observation passed to the pdf function.
class Mvn
{
public:
    /// @brief Constructo
...
public:
    ...
    /**
     * prediction() method Predicts the state for the next time step
     *   using the process model.
