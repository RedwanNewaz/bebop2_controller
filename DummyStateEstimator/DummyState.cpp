...
namespace bebop2
{
    DummyState::DummyState(ros::NodeHandle& nh, bool noisy_reading):nh_(nh), noisy_reading_(noisy_reading)
    {
        ...
        sub_takeoff_ = nh_.subscribe("/bebop/takeoff", 10, &DummyState::takeoff_callback, this);
        sub_land_ = nh_.subscribe("/bebop/land", 10, &DummyState::land_callback, this);
        sub_cmd_vel_ = nh_.subscribe("/bebop/cmd_vel", 10, &DummyState::cmd_vel_callback, this);
